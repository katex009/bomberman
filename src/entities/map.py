...
class Map:
    def __init__(self, width=1024, height=768, tile_size=50):
        ...
        self.wall_bottom_tile = load_image("images/mapa/pared-inf.png", 54)
        ...
        self.wall_corner3_tile = load_image("images/mapa/pared-inf.png", tile_size)
        self.wall_corner4_tile = load_image("images/mapa/pared-inf.png", tile_size)

        self.bar = load_image("images/mapa/barra.png")
        
        self.tiles_x = 18 #width // tile_size 
        self.tiles_y = 11 #height // tile_size 
        self.tiles_y_d = 12 #width // tile_size 
    ...
    def draw(self, surface):
        ...
        for y  in range(self.tiles_y):
            ...
            surface.blit(self.wall_corner4_tile, (8, 718))
            surface.blit(self.wall_corner3_tile, (963, 718))
        ...
        for x  in range(self.tiles_x):
            ...
            surface.blit(self.wall_bottom_tile, (62 + x * self.tile_size , 718))
